...
from data_test.locators import StartPageLocators, AddUserLocators, ContactListLocators
...
def test_valid_credentials(driver):
    ...
    valcreds.open()
    valcreds.click_button(StartPageLocators.sing_up_button)
    ...
    headers_elements = valcreds.waiting_for_all_elements(ContactListLocators.headers)
